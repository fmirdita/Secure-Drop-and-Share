...
def run_part2_single_test(test_number):
    """Runs single functionality test."""
    testname, test = functionality_tests[test_number]
    print("============")
    print("Running test", testname)
    try:
        score = StudentTester("client").run_test(test)
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        ...
        print("PART 2 TEST NUMBER " + sys.argv[1])
        run_part2_single_test(test_number-1)
    else:
        print("invalid input")
